...
orbit_pdf_name = "outputs/earth_ellipse.pdf"
orbit_mp4_name = "outputs/earth_ellipse.mp4"
...
rs = 2954
ro = 151_820_000_000
k = 1.000000005 #(1-rs/ro)/np.sqrt(1-3*rs/(2*ro))
h = 14_857_341 #np.sqrt((rs/ro + (k*k - 1))*ro*ro/(1 - rs/ro))
